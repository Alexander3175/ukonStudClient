  ...
  return (
    <>
      <section className="w-[1000px] py-10">
        <div className="container mx-auto flex flex-wrap lg:flex-nowrap items-top px-4">
          <div className="w-full">
            <div className="max-w-sm mx-auto bg-white shadow-xl rounded-lg text-gray-900">
              ...
              <div className="text-center mt-4">
                <h2 className="font-bold text-xl">Sarah Smith</h2>
          ...
          <div className="w-full lg:w-2/3">
            <div>
              <h2 className="font-medium text-2xl mb-4">
                Games by Sarah Smith
              </h2>
            </div>
            <div className="border-b pb-5 ">
              <ul className="flex justify-between p-4 shadow-2xl rounded-lg gap-4 ">
                <li className="hover:text-blue-600 cursor-pointer">Want</li>
                <li className="hover:text-blue-600 cursor-pointer">Playing</li>
                <li className="hover:text-blue-600 cursor-pointer">Beaten</li>
                <li className="hover:text-blue-600 cursor-pointer">Archived</li>
              </ul>
            </div>
          </div>
        </div>
